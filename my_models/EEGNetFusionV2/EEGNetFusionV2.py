...
class EEGNetFusion(torch.nn.Module):
    def __init__(
        ...
        # branch 4
        cnn_temporal_kernels_b4=32,
        cnn_temporal_kernelsize_b4=(512, 1),
        cnn_sep_temporal_kernelsize_b4=(64, 1),

        # branch 5
        cnn_temporal_kernels_b5=64,
        cnn_temporal_kernelsize_b5=(1024, 1),
        cnn_sep_temporal_kernelsize_b5=(128, 1),
        ...
        self.cnn_temporal_kernel_counts = {
            ...
            "b4": cnn_temporal_kernels_b4,
            "b5": cnn_temporal_kernels_b5,
        }
        ...
        self.cnn_temporal_kernelsizes = {
            ...
            "b4": cnn_temporal_kernelsize_b4,
            "b5": cnn_temporal_kernelsize_b5,
        }
        ...
        self.cnn_sep_temporal_kernelsizes = {
            ...
            "b4": cnn_sep_temporal_kernelsize_b4,
            "b5": cnn_sep_temporal_kernelsize_b5,
        }
        ...
        # BRANCH MODULE 4
        #####################################################
        self.branch_module_4 = torch.nn.Sequential()
        ...
        self.branch_module_4.add_module(
            ...
            sb.nnet.CNN.Conv2d(
                in_channels=1,
                out_channels=self.cnn_temporal_kernel_counts["b4"],
                kernel_size=self.cnn_temporal_kernelsizes["b4"],
                padding="same",
                padding_mode="constant",
                bias=False,
                swap=True,
        ...
        self.branch_module_4.add_module(
            f"temp_bnorm_b4",
            sb.nnet.normalization.BatchNorm2d(
                input_size=self.cnn_temporal_kernel_counts["b4"],
                affine=True,
            ),
        )
        ...
        # num of spatial depthwise filters
        cnn_depth_kernels = (
            self.cnn_temporal_kernel_counts["b4"] * cnn_depth_multiplier
        )
        ...
        self.branch_module_4.add_module(
            f"depth_conv_b4",
            sb.nnet.CNN.Conv2d(
                in_channels=self.cnn_temporal_kernel_counts["b4"],
                out_channels=cnn_depth_kernels,
                kernel_size=(1, C),
                padding="valid",
                bias=False,
        ...
        # separable temporal (depthwise_component)
        self.branch_module_4.add_module(
            f"sep_temp_depth_conv_b4",
            sb.nnet.CNN.Conv2d(
                in_channels=cnn_depth_kernels,
                out_channels=cnn_sep_temporal_kernels,
                kernel_size=self.cnn_sep_temporal_kernelsizes["b4"],
                groups=cnn_depth_kernels,
                padding="same",
                padding_mode="constant",
                bias=False,
        ...
        # BRANCH MODULE 5
        #####################################################
        self.branch_module_5 = torch.nn.Sequential()
        ...
        self.branch_module_5.add_module(
            ...
            sb.nnet.CNN.Conv2d(
                in_channels=1,
                out_channels=self.cnn_temporal_kernel_counts["b5"],
                kernel_size=self.cnn_temporal_kernelsizes["b5"],
                padding="same",
                padding_mode="constant",
                bias=False,
                swap=True,
        ...
        self.branch_module_5.add_module(
            f"temp_bnorm_b5",
            sb.nnet.normalization.BatchNorm2d(
                input_size=self.cnn_temporal_kernel_counts["b5"],
                affine=True,
            ),
        )
        ...
        # num of spatial depthwise filters
        cnn_depth_kernels = (
            self.cnn_temporal_kernel_counts["b5"] * cnn_depth_multiplier
        )
        ...
        self.branch_module_5.add_module(
            f"depth_conv_b5",
            sb.nnet.CNN.Conv2d(
                in_channels=self.cnn_temporal_kernel_counts["b5"],
                out_channels=cnn_depth_kernels,
                kernel_size=(1, C),
                padding="valid",
                bias=False,
        ...
        # separable temporal (depthwise_component)
        self.branch_module_5.add_module(
            f"sep_temp_depth_conv_b5",
            sb.nnet.CNN.Conv2d(
                in_channels=cnn_depth_kernels,
                out_channels=cnn_sep_temporal_kernels,
                kernel_size=self.cnn_sep_temporal_kernelsizes["b5"],
                groups=cnn_depth_kernels,
                padding="same",
                padding_mode="constant",
                bias=False,
        ...
        output_b4 = self.branch_module_4(sample_input)
        branch_outputs.append(output_b4)
        output_b5 = self.branch_module_5(sample_input)
        branch_outputs.append(output_b5)
    ...
    def forward(self, x):
        ...
        x_4 = self.branch_module_4(x)
        branch_outputs.append(x_4)
        x_5 = self.branch_module_5(x)
        branch_outputs.append(x_5)
